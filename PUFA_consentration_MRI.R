...
for (i in names(PUFA)[-1]){
  for (j in names(aparc_volume)[-1]){
    PUFA_aparc_volume_list[[i]][[j]] <- lm2022c(PUFA_aparc_volume_Cov[i],PUFA_aparc_volume_Cov[j],PUFA_aparc_volume_Cov)
  }
}
...
for (i in names(PUFA)[-1]){
  for (j in names(aparc_area)[-1]){
    PUFA_aparc_area_list[[i]][[j]] <- lm2022c(PUFA_aparc_area_Cov[i],PUFA_aparc_area_Cov[j],PUFA_aparc_area_Cov)
  }
}
...
for (i in names(PUFA)[-1]){
  for (j in names(aparc_thickness)[-1]){
    PUFA_aparc_thickness_list[[i]][[j]] <- lm2022c(PUFA_aparc_thickness_Cov[i],PUFA_aparc_thickness_Cov[j],PUFA_aparc_thickness_Cov)
  }
}
...
for (i in names(PUFA)[-1]){
  for (j in names(aseg_volume)[-1]){
    PUFA_aseg_volume_list[[i]][[j]] <- lm2022c(PUFA_aseg_volume_Cov[i],PUFA_aseg_volume_Cov[j],PUFA_aseg_volume_Cov)
  }
}
